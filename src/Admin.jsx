      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        ...
        {activeTab === 'logbook' && (
          <section className="space-y-2">
            <img src="/images/log-book-banner.jpg" alt="" className="w-full h-auto rounded-3xl shadow-sm mb-2 object-cover" />
            <div className="rounded-3xl shadow-sm p-6 mb-4 bg-indigo-50 border border-indigo-100">
              ...
              <p className="text-5xl font-extrabold text-indigo-900 mt-4 tracking-tight">{totalScans}<span className="text-base font-medium text-indigo-400 ml-2">total logged</span></p>
            </div>
            {scanEntries.length === 0 && <div className="text-center text-stone-500">No scans logged yet</div>}
            {scanEntries.map((e) => (
              <div key={e.id} className="flex items-center justify-between bg-white border border-stone-200 rounded-2xl shadow-sm px-4 py-3">

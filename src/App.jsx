          ...
          <>
            ...
            <section className="bg-white border border-stone-200 rounded-3xl shadow-sm p-6 mb-6">
              <div className="mb-1 flex items-baseline justify-between">
                <span className="text-sm text-stone-500">How many scans?</span>
                <span className="text-3xl font-extrabold text-stone-900">{scanCount}</span>
              </div>
              <input
                type="range"
                min="1"
              ...
              />
              <div className="flex justify-between text-[10px] text-stone-400 px-0.5 mb-2">

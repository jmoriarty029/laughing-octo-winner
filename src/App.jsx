          ...
          <>
            ...
            <section className="grid grid-cols-3 gap-3 mb-6">
              <div className="bg-stone-100 rounded-3xl shadow-sm p-4">
                ...
                <p className="text-2xl font-extrabold text-stone-900">{stats.total}</p>
              </div>
              <div className="bg-rose-50 rounded-3xl shadow-sm p-4">
                <p className="text-xs text-rose-500 font-medium">Requests</p>
                <p className="text-2xl font-extrabold text-rose-700">{stats.requests}</p>
              </div>
            ...
            <section className="rounded-3xl shadow-sm p-6 mb-6 bg-indigo-50 border border-indigo-100">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="e.g. 12"
                  className="border border-indigo-200 bg-white text-indigo-900 placeholder-indigo-300 rounded-xl px-3 py-2 flex-grow"
                />
                <button onClick={logScan} className="px-4 py-2 rounded-xl bg-indigo-900 hover:bg-indigo-800 text-white font-semibold whitespace-nowrap">Log it</button>
              </div>
            </section>
